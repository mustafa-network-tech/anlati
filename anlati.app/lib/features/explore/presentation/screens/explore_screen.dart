          ...
          children: [
            ...
            SizedBox(
              ...
              child:  ListView(
                ...
                children: [
                  _SortChip(label: 'En Yeni',      value: 'created_at',   provider: _sortProvider),
                  _SortChip(label: 'En Çok Okunan', value: 'read_count',  provider: _sortProvider),
                  _SortChip(label: 'En Çok Yorum',  value: 'comment_count', provider: _sortProvider),
                  _SortChip(label: 'En Çok Beğeni', value: 'like_count',  provider: _sortProvider),
                ],
              ),
            ),
            ...
            Expanded(
              child: storiesAsync.when(
                ...
                error: (e, _) => EmptyStateWidget(
                  ...
                  onAction: () => ref.invalidate(storiesProvider(category)),
                ),
                data: (stories) {
                  final filtered = query.isEmpty
                      ...
                      : stories.where((s) =>
                          ...
                          s.category.contains(query.toLowerCase())).toList();
                    ...
                    itemBuilder: (ctx, i) => StoryCardWidget(
                      ...
                      onLike: () async {
                        ...
                        await StoriesRepository.instance.toggleLike(
                          filtered[i].id, uid, filtered[i].isLiked,
                        );
                      ...
                      onBookmark: () async {
                        ...
                        await StoriesRepository.instance.toggleBookmark(
                          filtered[i].id, uid, filtered[i].isBookmarked,
                        );
                        ref.invalidate(storiesProvider(category));
                      },
                    ),
